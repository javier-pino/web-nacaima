       ...
       <div id="Page">
           <div id="Content">
				...
				<table align="left">
					...
					<tr>
						<td>			
						<SELECT tabindex="1" name="idestado" id="idestado" title="estado" style="width: 250px;" onchange="javascript:mostrarMunicipios(this.value);">
						<%
							int idEstado;
					...
					<td id= "municipios">
						<SELECT tabindex="2" name="idmunicipio" id="idmunicipio" title="municipio" style="width: 250px;" >
							<option value="0">--Seleccione--</option>
						</SELECT>
					</td>
					<td id= "parroquias">
						<SELECT tabindex="3" name="idparroquia" id="idparroquia" title="parroquia" style="width: 250px;" >
							<option value="0">--Seleccione--</option>
						</SELECT>
					</td>
					</tr>
