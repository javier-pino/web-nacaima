...
//******************************************************************************
    ...
    var scwBaseYear        = scwDateNow.getFullYear()-14;
    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// English
             scwToday               = 'Hoy:';
             scwClear               = 'Borrar';
             scwDrag                = 'click para arrastrar';
             scwArrMonthNames       = ['Enero','Febrero','Marzo','Abril','Mayo','Junio',
                                       'Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre'];
             scwArrWeekInits        = ['Do','Lu','Ma','Mi','Ju','Vi','Sa'];
             scwInvalidDateMsg      = 'Fecha inválida.\n';
             scwOutOfRangeMsg       = 'Fecha fuera de rango.';
    ...
    //scwDisabledDates[0] = [new Date(scwDateNow.getFullYear(),scwDateNow.getMonth(),scwDateNow.getDay()+4 ),new Date(scwDateNow.getFullYear(),11,31)];
    //
